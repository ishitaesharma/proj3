				...
				<div class="col-md-4 mb-4">
					...
					<div class="card">
						<div class="card-body">
							...
							if (id >0)  {
							%>
							<h3 class="text-center font-weight-bold"><font color="#a64d79">Update Subject</font></h3>
							<%
								} else {
							%>
							<h3 class="text-center font-weight-bold"><font color="#a64d79">Add Subject</font></h3>
							<%
								}
							%>
							<!--Body-->
