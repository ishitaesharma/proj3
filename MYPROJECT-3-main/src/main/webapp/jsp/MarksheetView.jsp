						...
						<div class="card-body">
							<%
							  long id=DataUtility.getLong(request.getParameter("id"));
								...
								if (id >0) {
							%>
							<h3 class="text-center font-weight-bold"><font color="#a64d79">Update Marksheet</font>
							</h3>
							<%
								} else {
							%>
							<h3 class="text-center font-weight-bold"><font color="#a64d79">Add Marksheet</font></h3>
							<%
								}
							%>
