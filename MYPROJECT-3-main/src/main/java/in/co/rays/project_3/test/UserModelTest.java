...
public class UserModelTest {
	...
	public static void addTest() throws Exception {
		...
		dto.setFirstName("Ishita");
		dto.setLastName("Sharma");
		dto.setDob(sdf.parse("30-05-1999"));
		dto.setConfirmPassword("12345");
		dto.setPassword("12345");
		dto.setLogin("ishitasharma996@gmail.com");
		dto.setGender("Female");
		dto.setUnSuccessfullLogin(0);

		dto.setCreatedBy("ADMIN");
		dto.setModifiedBy("ADMIN");
		dto.setRoleId(1);
		dto.setMobileNo("9446328751");
		dto.setRegisteredIP("ishita@gmail.com");
		dto.setLoginIP("ishita@gmail.com");
