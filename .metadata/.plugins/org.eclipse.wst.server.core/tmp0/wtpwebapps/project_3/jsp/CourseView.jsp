				...
				<div class="col-md-4 ">
					<div class="card">
						<div class="card-body">
							...
							if (id >0)  {
							%>
							<h3 class="text-center font-weight-bold"><font color="#a64d79">Update Course</font></h3>
							<%
								} else {
							%>
							<h3 class="text-center font-weight-bold"><font color="#a64d79">Add Course</font></h3>
							<%
								}
							%>
							<!--Body-->
