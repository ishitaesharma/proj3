					...
					<div class="card">
						<div class="card-body">
							<%
								...
								if (id > 0) {
							%>
							<h3 class="text-center font-weight-bold"><font color="#a64d79">Update Time Table</font></h3>
							<%
								} else {
							%>
							<h3 class="text-center font-weight-bold"><font color="#a64d79">Add Time Table</font></h3>
							<%
								}
							%>
							<!--Body-->
