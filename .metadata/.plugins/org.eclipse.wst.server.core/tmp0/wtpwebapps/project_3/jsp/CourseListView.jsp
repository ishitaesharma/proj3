		...
		<form action="<%=ORSView.COURSE_LIST_CTL%>" method="post">
			...
			<center>
				<h1 class="font-weight-bold pt-3">
					<font color="#a64d79">Course List</font>
				</h1>
				<center>
			...
			%>
			<center>
					<h1 class="font-weight-bold pt-3"><font color="#a64d79">College List</font></h1>
				</center>
				</br>
				<div class="row">
				<div class="col-md-4"></div>
			...
			<div style="padding-left: 48%;">
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					style="font-size: 17px" value="<%=CourseListCtl.OP_BACK%>">
			</div>
			<%
				}
			%>
